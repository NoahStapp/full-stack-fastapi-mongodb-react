                    ...
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="space-y-1">
                                <label htmlFor="confirmation" className="block text-sm font-medium text-gray-700">Repeat password</label>
                                <div className="mt-1 group relative inline-block w-full">
                                ...
                                {errors.password && <div id="confirmation" className="absolute left-5 top-5 translate-y-full w-48 px-2 py-1 bg-gray-700 rounded-lg text-center text-white text-sm after:content-[''] after:absolute after:left-1/2 after:bottom-[100%] after:-translate-x-1/2 after:border-8 after:border-x-transparent after:border-t-transparent after:border-b-gray-700"/>}
                                </div>
                            </div>
                            <div>
