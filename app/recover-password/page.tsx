            ...
            <div className="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div>
                        ...
                        <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900">Recover your account</h2>
                    </div>
                    <div className="mt-8">
                        <div className="mt-6">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-right">
                                    <Link href="/login" className="font-medium text-rose-500 hover:text-rose-600">Login to your account</Link>
                                </div>
                            </div>
                            <div>
