...
import { disableTOTPAuthentication, enableTOTPAuthentication, profile, updateUserProfile } from "../../lib/slices/authSlice"
            ...
            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                  <QrCodeIcon className="h-6 w-6 text-rose-500" aria-hidden="true" />
                </div>
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900">Enable two-factor security</Dialog.Title>
                    ...
                    <ul role="list" className="space-y-3">
                      ...
                      <li className="flex items-start">
                        ...
                        <div className="ml-3 text-sm leading-6 text-gray-600">
                          ...
                          <p className="text-md font-semibold my-2 text-center">{totpNew.key}</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0">
                        ...
                        <div className="ml-3 text-sm leading-6 text-gray-600">
                          ...
                          <form onSubmit={handleSubmitTotp(enableTOTP)} validation-schema="totpSchema">
                            ...
                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                              <button type="submit" className="inline-flex w-full justify-center rounded-md border border-transparent bg-rose-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">
                                Submit
                              </button>
