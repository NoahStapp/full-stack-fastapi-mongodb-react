...
const renderUserProfiles = (userProfiles: IUserProfile[]) => {
  return userProfiles.map(profile => 
    <tr key={profile.id}>
      ...
      <td className="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell">{profile.email}</td>
    ...
    <table className="min-w-full divide-y divide-gray-300">
      <thead className="bg-gray-50">
        <tr>
          ...
          <th scope="col" className="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Validated</th>
          <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Active</th>
          <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Moderator</th>
        </tr>
      </thead>
