                        ...
                        <div className="relative flex h-16 justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <Link href="/" className="flex flex-shrink-0 items-center">
                                    <img className="block h-8 w-auto lg:hidden" src="https://tailwindui.com/img/logos/mark.svg?color=rose&shade=600" alt="Your Company" />
                                    <img className="hidden h-8 w-auto lg:block" src="https://tailwindui.com/img/logos/mark.svg?color=rose&shade=600" alt="Your Company" />
                                </Link>
                                </div>
                                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                                    {renderNavLinks("inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900 hover:text-rose-500")}
                                </div>
                            </div>
                            ...
                            <div className="space-y-1 pt-2 pb-4">
                                {renderNavLinks("block hover:border-l-4 hover:border-rose-500 hover:bg-rose-50 py-2 pl-3 pr-4 text-base font-medium text-rose-700")}
                            </div>
                        </Disclosure.Panel></>
        )}
        </Disclosure>
