...
export default function Notification() {
    ...
    return (
        <div aria-live="assertive" className="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6">
            ...
            {/* <transition enter-active-className="transform ease-out duration-300 transition" enter-from-className="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2" enter-to-className="translate-y-0 opacity-100 sm:translate-x-0" leave-active-className="transition ease-in duration-100" leave-from-className="opacity-100" leave-to-className="opacity-0"> */}
            {show && (
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 w-0 flex-1 pt-0.5">
                                <p className="text-sm font-medium text-gray-900">{firstNotification.title}</p>
                                <p className="mt-1 text-sm text-gray-500">{firstNotification.content}</p>
                            </div>
